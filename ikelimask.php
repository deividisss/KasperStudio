...
<html lang="en">
    ...
    <body>
        <h1 style="text-align: center">Krikstynu Galerija</h1>
<form action="ikelimask.php" method="post" enctype="multipart/form-data">
     ...
     if(($image_name=='') or ($imagethumb_name==''))   {  
          ...
          if($image_name!=$imagethumb_name){
              ...
              exit();}
                    ...
                    ///move_uploaded_file($_FILES.$image_tmp_name,"galerijos/krikstynos/images/$image_name");
          move_uploaded_file($image_tmp_name,"galerijos/krikstynos/images/$image_name");
           move_uploaded_file($imagethumb_tmp_name,"galerijos/krikstynos/images/thumbs/$imagethumb_name");
          echo "Nuotrauka ikelta sekminga";
          echo "<br><img src='galerijos/krikstynos/images/$image_name'><br>";
           echo "Thumbnailas ikelta sekminga<br>";
          echo "<br><img src='galerijos/krikstynos/images/thumbs/$imagethumb_name'>";
}
