...
<form action="ikelimasf.php" method="post" enctype="multipart/form-data">
...
if (isset($_POST['upload'])){
     ...
     if(($image_name=='') or ($imagethumb_name==''))   {  
          ...
          move_uploaded_file($image_tmp_name,"galerijos/fotosesijos/images/$image_name");
           move_uploaded_file($imagethumb_tmp_name,"galerijos/fotosesijos/images/thumbs/$imagethumb_name");
          echo "Nuotrauka ikelta sekminga";
          echo "<br><img src='galerijos/fotosesijos/images/$image_name'><br>";
           echo "Thumbnailas ikelta sekminga<br>";
          echo "<br><img src='galerijos/fotosesijos/images/thumbs/$imagethumb_name'>";
}
